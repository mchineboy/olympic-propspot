<script lang="ts">
  ...
  <div class="flex items-center justify-center min-h-screen px-4 bg-gradient-to-b from-purple-900 to-black">
	<div class="w-full max-w-md space-y-8">
	  <div class="text-center">
		<h1 class="text-5xl font-extrabold text-yellow-400 drop-shadow-lg">
		  Welcome to the Show
		</h1>
	  ...
	  <div class="text-center text-yellow-200">
		New to the theater? <a href="/register" class="font-medium text-yellow-400 hover:text-yellow-300">Register here</a>
	  </div>
	</div>
  </div>